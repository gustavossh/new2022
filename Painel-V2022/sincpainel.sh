#!/bin/bash
clear
echo -e "\033[1;36mINSTALANDO O SINCRONIZADOR JSINFINITY-SSH\033[0m"
...
wget github.com/gustavossh/new2022/raw/main/Painel-V2022/sshplus.zip.001 > /dev/null 2>&1
wget github.com/gustavossh/new2022/raw/main/Painel-V2022/sshplus.zip.002 > /dev/null 2>&1
wget github.com/gustavossh/new2022/raw/main/Painel-V2022/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget github.com/gustavossh/new2022/raw/main/Painel-V2022/sincpainel.zip > /dev/null 2>&1
