...
echo ""
echo -e "                 \033[1;31mBy @JSINFINITT\033[1;36m"
echo ""
...
sleep 5
cd /bin || exit
wget https://github.com/gustavossh/new2022/raw/main/Painel-V2022/chuser > /dev/null 2>&1
wget https://github.com/gustavossh/new2022/raw/main/Painel-V2022/userscheck > /dev/null 2>&1
...
wget https://github.com/gustavossh/new2022/raw/main/Painel-V2022/checkuser.py > /dev/null 2>&1
